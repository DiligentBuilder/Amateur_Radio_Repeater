...
const int interWordDelay = 7 * dotDuration;
...
void loop() {
      ...
      if (buffer_string.length() >= 14) {
        ...
        if (isChangePassword) {
          ...
          String buffer_string_substring = buffer_string.substring(1, 7);
          
          EEPROM.get(0, old_password);

          char buffer_string_substring_char_array[6];
          buffer_string_substring.toCharArray(buffer_string_substring_char_array, 7);

          char old_password_char_array[6];
          old_password.toCharArray(old_password_char_array, 7);
          ...
          if (strcmp(buffer_string_substring_char_array, old_password_char_array) == 0) {
            ...
            EEPROM.put(0, buffer_string.substring(8, 14));
